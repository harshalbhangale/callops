...
export default function GoogleSignIn() {
  return (
    <motion.button
      ...
      whileTap={{ scale: 0.98 }}
      className="group relative flex items-center justify-center gap-4 px-10 py-5 bg-white text-gray-800 rounded-2xl font-bold text-lg shadow-2xl hover:shadow-3xl transition-all duration-300 tap-target overflow-hidden"
    >
